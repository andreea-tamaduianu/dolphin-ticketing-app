...
//Sample: Table - Scroll To Index
    ...
    var SettingsDialogController = Controller.extend("sap.ui.dolphin.controller.TicheteRezolvate", {
		...
		onInit: function () {
			...
			//this.getView().setModel(oModel);
                        ...
                        //this.getView().setModel(oModel, "TicheteRezolvateModel");
                        //alert( "Altert 2" );            
                        ...
                        $.ajax({
                                ...
                                //alert( model );
			        model.setProperty("/ticheteRezolvate", data.listaTichete)
                ...
                seteazaStareInchis: function (oEvent) {
                  ...
                  $.ajax({
                                ...
                                if( data.stare_modificata ) {
                                  ...
                                  //sap.m.MessageBox.success("Tichetul cu numarul "+ obj.nr_tichet + " a fost inchis! ");
                                  sap.m.MessageBox.information("Tichetul cu numarul "+ obj.nr_tichet + " a fost inchis!  ", {
                ...
                seteazaStare: function (oEvent) {
                  ...
                  $.ajax({
                                ...
                                if( data.stare_modificata ) {
                                   // Ar trebui sa intrebam daca doreste navigare in pagina cu TicheteInLucru  
                                  //sap.m.MessageBox.success("Tichetul cu numarul "+ obj.nr_tichet + " a fost relansat in executie! ");
                                  sap.m.MessageBox.information("Tichetul cu numarul "+ obj.nr_tichet + " a fost relansat in executie! ", {
                                                                    actions: [sap.m.MessageBox.Action.CLOSE],
                                                                    onClose: function (sAction) {
                                                                        window.location.reload();
                                                                    }
...
//			}
		...
		handleSortDialogConfirm: function (oEvent) {
			var oTable = this.byId("idTicheteRezolvate"),
		...
		onToggleContextMenu: function (oEvent) {
			if (oEvent.getParameter("pressed")) {
				this.byId("idTicheteRezolvate").setContextMenu(new Menu({
					items: [
				...
				this.byId("idTicheteRezolvate").destroyContextMenu();
			}
		}
	});
