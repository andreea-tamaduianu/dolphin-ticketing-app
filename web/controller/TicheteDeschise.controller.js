...
//Sample: Table - Scroll To Index
    ...
    var SettingsDialogController = Controller.extend("sap.ui.dolphin.controller.TicheteDeschise", {
		...
		onInit: function () {
			...
			//this.getView().setModel(oModel);
                        ...
                        //this.getView().setModel(oModel, "TicheteDeschiseModel");
                        //alert( "Altert 2" );            
                        ...
                        $.ajax({
                                ...
                                //alert( model );
			        model.setProperty("/ticheteDeschise", data.listaTichete)
                ...
                seteazaStare: function (oEvent) {
                  ...
                  $.ajax({
                                ...
                                if( data.stare_modificata ) {
                                  ...
                                  //alert("Tichetul cu numarul "+ obj.nr_tichet + " a fost lansat in executie! ");
                                  //sap.m.MessageBox.success("Tichetul cu numarul "+ obj.nr_tichet + " a fost lansat in executie! ");
                                  sap.m.MessageBox.information("Tichetul cu numarul "+ obj.nr_tichet + " a fost lansat in executie! ", {
...
//			}
		...
		handleSortDialogConfirm: function (oEvent) {
			var oTable = this.byId("idTicheteDeschise"),
		...
		onToggleContextMenu: function (oEvent) {
			if (oEvent.getParameter("pressed")) {
				this.byId("idTicheteDeschise").setContextMenu(new Menu({
					items: [
				...
				this.byId("idTicheteDeschise").destroyContextMenu();
			}
		}
	});
